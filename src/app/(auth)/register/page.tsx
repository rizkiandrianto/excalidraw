    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-500 mt-1 text-sm">
          {fromGoogle
            ...
            : "Start building your canvases"}
        </p>
      </div>

      {fromGoogle && (
        <div className="flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-lg px-3.5 py-2.5 mb-5">
          ...
          <p className="text-sm text-blue-700">Signing up via Google</p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          />
          {fromGoogle && (
            <p className="text-xs text-neutral-400 mt-1">Email is locked to your Google account</p>
          )}
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-neutral-700 mb-1.5">
            Password
            {fromGoogle && <span className="text-neutral-400 font-normal ml-1">(set one to also enable email login)</span>}
          </label>
          <input
            type="password"
            value={password}
